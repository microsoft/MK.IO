...
namespace MK.IO.Operations
{
    public interface IContentKeyPoliciesOperations
    {
        ...
        /// </summary>
        /// <param name="orderBy">Specifies the key by which the result collection should be ordered. Specify a field name, and optionally asc or desc. Sorting is valid on the following fields: name, properties/created, properties/description, properties/lastModified, properties/policyId</param>
        /// <param name="filter">Restricts the set of items returned. Filters are valid on the following fields: name, properties/created, properties/description, properties/lastModified, properties/policyId</param>
        ...
        /// <summary>
        /// List the Content Key Policies using pages.
        /// </summary>
        /// <param name="orderBy">Specifies the key by which the result collection should be ordered. Specify a field name, and optionally asc or desc. Sorting is valid on the following fields: name, properties/created, properties/description, properties/lastModified, properties/policyId</param>
        /// <param name="filter">Restricts the set of items returned. Filters are valid on the following fields: name, properties/created, properties/description, properties/lastModified, properties/policyId</param>
        /// <param name="top">Specifies a non-negative integer that limits the number of items returned from a collection. The service returns the number of available items up to but not greater than the specified value top.</param>
        ...
        /// <summary>
        /// List the Content Key Policies using next pages.
        /// </summary>
